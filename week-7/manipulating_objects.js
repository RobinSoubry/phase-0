...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  I had trouble with test 8. Ittook me some time to realize that carson was an object by itself, not simply a name attached to 'children'.
  I read the instructions carefully and looked at the test-code to better understand what was required.

How difficult was it to add and delete properties outside of the object itself?
  It's very straightforward and a natural way of working with a data structure / hierarchy.

What did you learn about manipulating objects in this challenge?
  It's very easy to chain levels of objects together and link items to each other (like the terah.spouse = adam and vice versa)
